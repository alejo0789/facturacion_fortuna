...
def _new_jti() -> str:
    """UUID hex de 32 chars para identificar cada token de manera única.

    Se pone como claim `jti` — permite revocación individual del token vía
    la tabla `token_blacklist`.
    """
    import secrets
